 ...
 */
FIL* eFile_WOpen(const char name[]);      // open a file for writing 
 ...
 */
FIL* eFile_ROpen(const char name[]);      // open a file for reading 
...
/**
 * @details Create a new, empty directory within the current directory
 * @param  name file name is an ASCII string up to seven characters
 * @return 0 if successful and 1 on failure (e.g., already exists or directory full)
 * @brief  Create a new file
 */
int eFile_DCreate(const char name[]);  // create new empty directory
